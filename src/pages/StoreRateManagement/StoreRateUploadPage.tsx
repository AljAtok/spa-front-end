...
const StoreRateUploadPage: React.FC = () => {
  ...
  const handleDownloadTemplate = () => {
    ...
    link.download = "STORE-RATE-UPLOAD-TEMPLATE.xlsx";
  ...
  return (
    <Box maxWidth={900} mx="auto" mt={4}>
      <FormHeader
        title="Upload Store Rates"
        actionButton={
          <Button
            variant="outlined"
            color="success"
            startIcon={<ArrowBackIcon />}
            onClick={() => navigate("/store-rates")}
            sx={{ ml: 2 }}
          >
            Back to Store Rates
          </Button>
                  ...
                  <Table size="small">
                    <TableHead>
                      <TableRow>
                        ...
                        <TableCell>Warehouse Rate</TableCell>
                      ...
                      {result.success.map(
                        (row: UploadSuccessRow, idx: number) => (
                          <TableRow key={idx}>
                            ...
                            <TableCell>{row.warehouse_rate}</TableCell>
...
export default StoreRateUploadPage;
