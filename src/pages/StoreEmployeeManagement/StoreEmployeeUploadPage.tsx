...
const StoreEmployeeUploadPage: React.FC = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await post<UploadResult>(
        "/warehouse-employees/upload-excel",
        formData,
        undefined,
        {
  ...
  const handleDownloadTemplate = () => {
    ...
    }/uploads/UPLOAD-TEMPLATE/STORE-EMP-UPLOAD-TEMPLATE.xlsx`;
    link.download = "STORE-EMP-UPLOAD-TEMPLATE.xlsx";
  ...
  return (
    <Box maxWidth={1000} mx="auto" mt={4}>
      {/* <Button variant="outlined" onClick={() => navigate(-1)} sx={{ mb: 2 }}>
        Back to Store Employees
      </Button> */}
      <FormHeader
        title="Upload Store Personnel"
        actionButton={
          <Button
            variant="outlined"
            color="success"
                  ...
                  <Table size="small">
                    <TableHead>
                      <TableRow>
                        ...
                        <TableCell>GBCH</TableCell>
                        <TableCell>RH</TableCell>
                        <TableCell>GRH</TableCell>
                      ...
                      {result.success.map(
                        (row: UploadSuccessRow, idx: number) => (
                          <TableRow key={idx}>
                            ...
                            <TableCell>{row.assigned_ss_name}</TableCell>
                            <TableCell>{row.assigned_ah_name}</TableCell>
                            <TableCell>{row.assigned_bch_name}</TableCell>
                            <TableCell>{row.assigned_gbch_name}</TableCell>
                            <TableCell>{row.assigned_rh_name}</TableCell>
                            <TableCell>{row.assigned_grh_name}</TableCell>
...
export default StoreEmployeeUploadPage;
