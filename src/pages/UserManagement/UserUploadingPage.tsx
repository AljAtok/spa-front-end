...
interface UserUploadSuccessRow {
  Username: string;
  "Employee No.": number;
  "First Name": string;
  "Last Name": string;
...
interface UserUploadResult {
  ...
  success: UserUploadSuccessRow[];
}

const UserUploadingPage: React.FC = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await post<UserUploadResult>(
        "/users/upload-excel",
        formData,
        undefined,
        {
  ...
  const handleDownloadTemplate = () => {
    ...
    }/uploads/UPLOAD-TEMPLATE/USERS-UPLOAD-TEMPLATE.xlsx`;
                    ...
                    <TableBody>
                      {result.success.map((row, idx) => (
                        <TableRow key={idx}>
                          ...
                          <TableCell>{row["Employee No."]}</TableCell>
...
export default UserUploadingPage;
